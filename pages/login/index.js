...
const Login = () => {
    ...
    return (
        <div className='w-full min-h-screen'>
            <h2 className='text-3xl my-8 text-center text-green-500'>Login</h2>
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className='w-2/3 lg:w-1/3 mx-auto border border-green-500 flex flex-col p-6 lg:p-6 rounded-md'>
                    ...
                    <small className='mt-4'>New to here? please <Link className='text-green-400 m1-3' href={'/register'}>Register</Link></small>
                    <button type='submit' className='mt-10 h-10 w-2/3 g:w-48 mx-auto bg-green-500 rounded-sm text-sm font-medium text-md active:bg-transparent active:border border-green-500'>Login</button>
                </div>
            </form >
        </div >
    );
